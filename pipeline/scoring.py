...
def score_event(
    ...
    with per-component breakdown for dashboard explainability.
    ...
    # --- Component-level intrinsic scoring ---
    c_monetary = 0.0
    if payload.get("has_monetary_value", False):
        amount = payload.get("amount", 0)
    ...
    # --- Component-level system state adjustments ---
